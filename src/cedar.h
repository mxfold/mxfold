...
namespace cedar {
  ...
  public:
...
#if __cplusplus >= 201103L
    da (da&& other) 
      : tracking_node (), _array (other._array), _ninfo (other._ninfo), 
        _block (other._block), _bheadF (other._bheadF), _bheadC (other._bheadC),
        _bheadO (other._bheadO), _capacity (other._capacity), _size (other._size),

        _no_delete (other._no_delete), _reject ()
    {
      std::copy(std::begin(other.tracking_node), std::end(other.tracking_node), std::begin(tracking_node));
      std::copy(std::begin(other._reject), std::end(other._reject), std::begin(_reject));
    ...
    da& operator= (da&& other)
    {
      ...
      _ninfo = other._ninfo; 
      _block = other._block;
      _bheadF = other._bheadF;
      _bheadC = other._bheadC;
      _bheadO = other._bheadO;
      _capacity = other._capacity;
      _size = other._size;
      _no_delete = other._no_delete;
      std::copy(std::begin(other.tracking_node), std::end(other.tracking_node), std::begin(tracking_node));
      std::copy(std::begin(other._reject), std::end(other._reject), std::begin(_reject));
      other._array = nullptr;
      other._ninfo = nullptr;
